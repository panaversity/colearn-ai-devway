...
exports.WEEKLY_CHECKLIST = exports.ALERT_RULES = exports.exportDashboardConfig = exports.getDashboardMetricIds = exports.getDashboard = exports.ALL_DASHBOARDS = exports.DASHBOARD_DEVICE_ANALYSIS = exports.DASHBOARD_TRAFFIC = exports.DASHBOARD_RESOURCE_ENGAGEMENT = exports.DASHBOARD_LEARNING_PROGRESSION = exports.DASHBOARD_CHAPTER_PERFORMANCE = exports.DASHBOARD_LEARNING_OVERVIEW = void 0;
// ==========================================
// DASHBOARD 1: Learning Overview
// ==========================================
exports.DASHBOARD_LEARNING_OVERVIEW = {
...
// ==========================================
exports.DASHBOARD_CHAPTER_PERFORMANCE = {
...
// ==========================================
exports.DASHBOARD_LEARNING_PROGRESSION = {
...
// ==========================================
exports.DASHBOARD_RESOURCE_ENGAGEMENT = {
...
// ==========================================
exports.DASHBOARD_DEVICE_ANALYSIS = {
    id: 'device-analysis',
...
var getDashboard = function (dashboardId) {
    return exports.ALL_DASHBOARDS.find(function (d) { return d.id === dashboardId; });
};
exports.getDashboard = getDashboard;
/**
 * Get all metric IDs from a dashboard
 */
var getDashboardMetricIds = function (dashboard) {
    return dashboard.metrics.map(function (m) { return m.id; });
};
exports.getDashboardMetricIds = getDashboardMetricIds;
/**
 * Export dashboard config for GA4 integration
 * Returns a JSON format suitable for GA4 API
 */
var exportDashboardConfig = function (dashboard) {
    return {
        ...
        metrics: dashboard.metrics.map(function (m) { return ({
            id: m.id,
            title: m.title,
            metric: m.metric,
...
exports.exportDashboardConfig = exportDashboardConfig;
exports.ALERT_RULES = [
    {
        id: 'high-bounce-rate',
