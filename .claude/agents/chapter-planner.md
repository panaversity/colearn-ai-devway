...
**Book Architecture**: Respect the chapter's role within its part and the book's 7-part structure (see `.specify/memory/constitution.md` Section III). Ensure lessons flow logically toward the chapter's stated learning objectives.
